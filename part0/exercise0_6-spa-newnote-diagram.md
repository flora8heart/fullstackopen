...
Note right of browser: A new note is submitted triggering the browser <br> to execute the JavaScript code fetched previously to <br>re-renders the note list with the new note on the page
